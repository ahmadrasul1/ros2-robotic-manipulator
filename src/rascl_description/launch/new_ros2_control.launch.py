...
def generate_launch_description():
    ...
    # ROS 2 Jazzy controller_manager receives the URDF from the
    ...
    def start_ros_after_ready_exit(event, _context):
        ...
        # Start controller_manager first so its robot_description subscriber
        # exists before robot_state_publisher publishes the URDF. The spawner
        # waits until controller_manager exposes its services.
        return [
            ros2_control_node,
